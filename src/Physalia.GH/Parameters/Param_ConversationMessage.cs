...
/// </summary>
public class Param_ConversationMessage : GH_Param<GH_ConversationMessage>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Param_ConversationMessage"/> class.
    /// </summary>
    public Param_ConversationMessage()
        : base("ConversationMessage", "Msg", "A single turn in a conversation.", "Physalia", "Params", GH_ParamAccess.item)
    {
    }
