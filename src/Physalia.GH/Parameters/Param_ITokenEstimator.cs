...
/// </summary>
public class Param_ITokenEstimator : GH_Param<GH_ITokenEstimator>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Param_ITokenEstimator"/> class.
    /// </summary>
    public Param_ITokenEstimator()
        : base("Token Estimator", "TokEst", "Estimates token consumption for a set of instructions.", "Physalia", "Params", GH_ParamAccess.item)
    {
    }
