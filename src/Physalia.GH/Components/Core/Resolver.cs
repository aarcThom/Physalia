...
public class Resolver : RoutingComponentBase<string>
{
    ...
    /// </summary>
    public Resolver()
        : base("Resolver", "Rslv", "Resolves generated component names to real installed components and stamps their type GUIDs; unresolved names route back as feedback.", "Core")
    {
    }
