---
name: collapsed-Chat-arrow
description: Collapsed Chat proxy shows a delegated bottom drag arrow when its harness holds exactly one transmitter
metadata: 
  node_type: memory
  type: project
