...
## Latest
- **[Yak publishing](yak-publishing.md) — 2026-09-09/10, `physalia 1.0.0`, `1.0.1`, `1.0.2` ARE PUBLISHED** (rh8_0-win, 19.7MB). **Read before any release**: the five-step run, commit-before-build, verifying the `.yak` before a permanent push, and the transcript a run-then-save bakes into a preset.
