...
public class ImageGatherer : PhyBase
{
    ...
    public ImageGatherer()
        : base("Image Gatherer", "ImgGather", "Gathers images from disk or the clipboard and outputs them as image sources for multimodal models. Right-click to manage images.", "Resources")
    {
    }
