...
**Superseded 2026-09-07 — the defect below was FIXED**, in `PhyBase.AutoPlacePicker`
(a restored component no longer auto-places one). Kept because the symptom is how you
recognise it in an OLD file, and because storing a real source on every input is still the
right thing to do. See [[teaching-presets]].
