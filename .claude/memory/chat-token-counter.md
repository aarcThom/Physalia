...
description: "Chat window token counter (bottom-right) mirrors a TokenEstimator wired downstream of the viewed chat's Conversation Log; hidden when none wired"
metadata: 
  node_type: memory
  type: project
