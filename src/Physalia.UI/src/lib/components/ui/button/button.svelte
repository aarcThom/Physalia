<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "neu-btn bg-[var(--neu-accent)] hover:bg-[var(--neu-accent-hover)] text-primary-foreground",
				outline: "neu-btn text-foreground",
				secondary: "neu-btn text-secondary-foreground",
				ghost: "neu-ghost text-foreground",
				destructive: "neu-btn bg-destructive/10 hover:bg-destructive/20 focus-visible:ring-destructive/20 text-destructive",
