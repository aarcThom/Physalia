...
## Latest
- **2026-08-07: a collapsed harness now travels with its Chat** — dragging the proxy translates every member's real pivot by the same delta (before, only the collapse point moved, so expanding dropped the group back at its old spot). See [[collapsible-harness]]. Live Rhino test pending.
