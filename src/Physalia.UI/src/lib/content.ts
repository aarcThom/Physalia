...
// Pure helpers for turning a raw assistant message (a single string) into the
// pieces the chat renders: reasoning vs. visible body, and prose vs. JSON.
// Nothing here knows about Svelte or the host bridge — it's just text in,
// structured data out, which makes it easy to read and reason about.
