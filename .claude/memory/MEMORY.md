...
- [Detect JSON gate](detect-json-gate.md) — presence gate Reasoner→Auditor: attempted JSON (even malformed) → Success; plain chat → Fail quietly (raw text, Remark). New `JsonDetector` in Core/Validation. 2026-07-03, builds+191 tests clean, live test pending.
