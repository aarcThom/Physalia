...
/// <summary>
/// The RECEIVER component executes a Python 3 script generated by a paired COMPOSER component.
...
/// </summary>
public class PyReceiver : ReceiverBase
{
    // FIELDS ==========================================================================================
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PyReceiver"/> class.
    /// </summary>
    public PyReceiver()
      : base(
            "PyReceiver",
    ...
    /// <summary>
    /// Appends a Disconnect Transmitter item to the standard component context menu.
    /// The item is greyed out when no TRANSMITTER is currently linked to this RECEIVER.
    /// </summary>
    ...
    public override void AppendAdditionalMenuItems(System.Windows.Forms.ToolStripDropDown menu)
    {
        ...
        // search the document for a transmitter that points at this receiver
        var linkedTransmitter = FindLinkedTransmitter();

        var item = Menu_AppendItem(menu, "Disconnect Transmitter", OnDisconnectTransmitter, linkedTransmitter != null);
        item.ToolTipText = "Remove the link between this RECEIVER and its TRANSMITTER.";
    }
    ...
    private void OnDisconnectTransmitter(object sender, EventArgs e)
    {
        var transmitter = FindLinkedTransmitter();
        if (transmitter == null)
        {
            return;
        }

        transmitter.ReceiverComponent = null;
        transmitter.ReceiverGuid = Guid.Empty;
        transmitter.ExpireSolution(true);
    }
}
