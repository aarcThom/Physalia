...
public class SignalLimiter : StatefulComponentBase
{
    ...
    public SignalLimiter()
        : base("Signal Limiter", "SigLim", "Routes the first N new signals through the Within Limit output and any beyond N through the Over Limit output. Reset zeroes the count.", "Utility")
    {
    }
