...
| **Extra** | `Extra/` | Serializer / Deserializer (.ghjson canvas export/import via `GhJsonBridge`), Picker (a value list whose choices come from the component it is wired to), Zoom Guid (zooms the canvas to a component by instanceGuid — a debugging aid) |
...
/Physalia
    ...
    /Files                       ← user-alterable runtime content ONLY; every folder here is read by code
        ...
        /MEMORIES         ← memory tool: /GLOBAL and /LOCAL/<harness-name>
```
