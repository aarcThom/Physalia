...
To stop wires being pulled out of a collapsed Physalia harness (the proxy Chatbox + its hidden members piled at the proxy pivot), you must gate the **parameter attributes'** `HasInputGrip`/`HasOutputGrip`, not the component's.
